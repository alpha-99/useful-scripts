#!/bin/bash
### it can find all same Classes in root directory and calculate similar of Jars according to containing how many same Classes. This is often use to find out the result that some functions has not work. like the order of class when they load.
### jar-conflict-detect path
